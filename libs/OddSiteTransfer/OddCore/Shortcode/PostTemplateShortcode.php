<?php
	namespace OddSiteTransfer\OddCore\Shortcode;
	
	use \OddSiteTransfer\OddCore\Shortcode\ShortcodeFilter;
	
	// \OddSiteTransfer\OddCore\Shortcode\PostTemplateShortcode
