<?php
	namespace OddSiteTransfer\OddCore\Admin\Lists;
	
	// \OddSiteTransfer\OddCore\Admin\Lists\EditList
	class EditList {
		...
		function __construct() {
			...
			$this->_columns["master-ingredient"] = new \OddSiteTransfer\OddCore\Admin\Lists\EditListColumn();
		}
