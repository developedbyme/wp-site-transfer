<?php
	namespace OddSiteTransfer\OddCore;
	
	// \OddSiteTransfer\OddCore\PluginBase
	class PluginBase {
		...
		protected function register_lists() {
			//echo("\OddSiteTransfer\OddCore\PluginBase::register_lists<br />");
		...
		protected function create_pages() {
			echo("\OddSiteTransfer\OddCore\PluginBase::create_pages<br />");
			
			//MENOTE: should be overridden
		}
		
		protected function register_pages() {
			//echo("\OddSiteTransfer\OddCore\PluginBase::register_pages<br />");
		...
		protected function add_custom_post_type($custom_post_type) {
			//echo("\OddSiteTransfer\OddCore\PluginBase::add_custom_post_type<br />");
			
			$this->_custom_post_types[$custom_post_type->get_system_name()] = $custom_post_type;
		}
		
		protected function create_custom_post_types() {
			//echo("\OddSiteTransfer\OddCore\PluginBase::create_custom_post_types<br />");
			
			//MENOTE: should be overridden
		}
		
		protected function register_custom_post_types() {
			//echo("\OddSiteTransfer\OddCore\PluginBase::register_custom_post_types<br />");
		...
		protected function add_filter($filter) {
			//echo("\OddSiteTransfer\OddCore\PluginBase::add_filter<br />");
			
			$this->_filters[] = $filter;
		}
		
		protected function create_filters() {
			//echo("\OddSiteTransfer\OddCore\PluginBase::create_filters<br />");
			
			//MENOTE: should be overridden
		}
		
		protected function register_filters() {
			//echo("\OddSiteTransfer\OddCore\PluginBase::register_filters<br />");
		...
		protected function get_pages() {
			//echo("\OddSiteTransfer\OddCore\PluginBase::get_pages<br />");
		...
		protected function get_custom_post_types() {
			//echo("\OddSiteTransfer\OddCore\PluginBase::custom_post_types<br />");
		...
		protected function get_filters() {
			//echo("\OddSiteTransfer\OddCore\PluginBase::get_filters<br />");
		...
		protected function register_ajax_api_end_points() {
			//echo("\OddSiteTransfer\OddCore\PluginBase::register_ajax_api_end_points<br />");
		...
		protected function get_ajax_api_end_points() {
			//echo("\OddSiteTransfer\OddCore\PluginBase::get_ajax_api_end_points<br />");
		...
		protected function create_rest_api_end_points() {
			//echo("\OddSiteTransfer\OddCore\PluginBase::create_rest_api_end_points<br />");
			
			//MENOTE: should be overridden
		}
		
		protected function register_rest_api_end_points() {
			//echo("\OddSiteTransfer\OddCore\PluginBase::register_rest_api_end_points<br />");
		...
		protected function get_rest_api_end_points() {
			//echo("\OddSiteTransfer\OddCore\PluginBase::get_rest_api_end_points<br />");
		...
		protected function add_shortcode($shortcode) {
			//echo("\OddSiteTransfer\OddCore\PluginBase::add_shortcode<br />");
			
			$this->_shortcodes[] = $shortcode;
		}
		
		protected function create_shortcodes() {
			//echo("\OddSiteTransfer\OddCore\PluginBase::create_shortcodes<br />");
			
			//MENOTE: should be overridden
		}
		
		protected function register_shortcodes() {
			//echo("\OddSiteTransfer\OddCore\PluginBase::register_shortcodes<br />");
		...
		protected function get_shortcodes() {
			//echo("\OddSiteTransfer\OddCore\PluginBase::get_shortcodes<br />");
		...
		protected function add_meta_box($system_name, $box, $post_type = 'post', $context = 'advanced', $priority = 'default') {
			$new_registration = new \OddSiteTransfer\OddCore\Admin\MetaData\PostMetaDataBoxRegistration();
		...
		protected function create_meta_boxes() {
			//echo("\OddSiteTransfer\OddCore\PluginBase::create_meta_boxes<br />");
			
			//MENOTE: should be overridden
		}
		
		protected function register_meta_boxes() {
			//echo("\OddSiteTransfer\OddCore\PluginBase::register_meta_boxes<br />");
		...
		protected function get_meta_boxes() {
			//echo("\OddSiteTransfer\OddCore\PluginBase::get_meta_boxes<br />");
		...
		public function hook_admin_menu() {
			//echo("\OddSiteTransfer\OddCore\PluginBase::hook_admin_menu<br />");
		...
		public function hook_edit_form_after_title() {
			//echo("\OddSiteTransfer\OddCore\PluginBase::hook_edit_form_after_title<br />");
		...
		public function hook_edit_form_after_editor() {
			//echo("\OddSiteTransfer\OddCore\PluginBase::hook_edit_form_after_editor<br />");
		...
		public function hook_save_post($post_id, $post, $update) {
			//echo("\OddSiteTransfer\OddCore\PluginBase::hook_save_post<br />");
		...
		public static function test_import() {
			echo("Imported \OddSiteTransfer\OddCore\PluginBase<br />");
		}
	}
?>